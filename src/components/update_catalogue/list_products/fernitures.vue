...
export default {
  ...
  data() {
    return {
      ...
      catalogItems: [
        { id:"abc",
          image:'https://m.media-amazon.com/images/I/51KtsYDkNtL.jpg',
          title:"Cauch",
          // color:"pink"
        },
        { id:"bcd",
          image:'https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcSVlvUEgkb1nrHcwhOZYx6g_4pz5Be3xuScQtXJIE8edO8ocDzsCnwGvc31PoF6USmC-ONBzKmlhQdV7DLO8MLEecL63M8uRIfrX9E2bkeIQqFQ_Yfvr8kTbg',
          title:"puffy cauch",
          // color:"pink"
        }
      ],
