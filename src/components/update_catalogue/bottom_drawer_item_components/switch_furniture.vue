        ...
        >
          ...
          >
            ...
            <a-row>
              ...
              <a-col
                span="6"
                style="display: flex; justify-content: end; gap: 2px"
              >
                <div
