...
<Teleport to="body">
  ...
  >
    ...
    >
      ...
      <div class="relative z-10 w-full max-w-[500px] bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <!-- Footer -->
        <div class="flex justify-end items-center gap-2 px-6 py-4 bg-gray-50 border-t border-gray-100">
          <button
            @click="closeInstructionModal"
  ...
  <div class="canvas-container" ref="canvasContainer">
    <img
        class="absolute top-[5px] right-[10px] sm:hidden  cursor-pointer z-9 w-[25px]"
