...
<div style="width:100%;background-color: white;padding:16px;" class="Generated_history">
    ...
    <!-- Empty State -->
    <div v-if="historyList.length === 0" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:60%;color:#999;">
      ...
      clicked_history(item,id){
        ...
        async fetchGenerateHistory() {
            ...
            try {
                ...
                const response = await fetch(this.$store.state.root_api + 'engine/get-home-design-history/', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
