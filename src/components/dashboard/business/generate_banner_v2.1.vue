...
<div style="display:flex;gap:10px;">
      ...
      <a-button @click="this.$router.push('/admin-generate-banner')" type="primary" size="medium">
        Admin Panel
      </a-button>
      <a-button  @click="showCreateModal = true" type="primary" size="medium" style="display:flex;gap:10px;">
        <template #icon>
          <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8.0026 5.83203V11.1654M10.6693 8.4987H5.33594" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M1.66406 8.5013C1.66406 5.51574 1.66406 4.02296 2.59156 3.09546C3.51906 2.16797 5.01184 2.16797 7.9974 2.16797C10.9829 2.16797 12.4757 2.16797 13.4033 3.09546C14.3307 4.02296 14.3307 5.51574 14.3307 8.5013C14.3307 11.4868 14.3307 12.9796 13.4033 13.9072C12.4757 14.8346 10.9829 14.8346 7.9974 14.8346C5.01184 14.8346 3.51906 14.8346 2.59156 13.9072C1.66406 12.9796 1.66406 11.4868 1.66406 8.5013Z" stroke="white"/>
          </svg>
          </template>
 Create New Banner
      </a-button>
      ...
      <template #overlay>
        <a-menu @click="handleMenuClick">
          <a-menu-item :key="selectedAspectRatio" @click="selectedAspectRatio = 'all'" >
          All
          </a-menu-item>
          <a-menu-item :key="selectedAspectRatio" @click="selectedAspectRatio = '1:1'" >
             1:1
          </a-menu-item>
          <a-menu-item :key="selectedAspectRatio" @click="selectedAspectRatio = '3:2'">
            3:2
          </a-menu-item>
           <a-menu-item :key="selectedAspectRatio" @click="selectedAspectRatio = '2:3'">
            2:3
          </a-menu-item>
        </a-menu>
      </template>
    ...
    :centered="true"
      ...
      <div v-if="currentStep === 0">
        ...
        <div style="display: flex; gap: 16px; flex-wrap: wrap; margin-bottom: 24px;">
          ...
          <div style="background:rgba(0,0,0,0.1);;border-radius:5px;padding:5px" @click="selectRatioForCreation('1:1')">
...
<rect x="0.5" y="0.5" width="13" height="13" rx="2.5" stroke="#4D4D4D"/>
          ...
          <div  style="background:rgba(0,0,0,0.1);;border-radius:5px;padding:5px" @click="selectRatioForCreation('3:2')">
...
<rect x="0.5" y="0.5" width="18" height="13" rx="2.5" stroke="#4D4D4D"/>
          ...
          <div style="background:rgba(0,0,0,0.1);;border-radius:5px;padding:5px" @click="selectRatioForCreation('2:3')">
              ...
              <div style="max-height: 600px; overflow-y: auto; padding-right: 8px;">
                ...
                <div>
                  ...
                  <div v-for="(mask, index) in workingMaskAreas" 
                    ...
                    <div v-if="mask.productPreview" style="width: 100%; height: 80px; background: #f3f4f6; border-radius: 4px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
...
<script>
import { CopyOutlined, PicRightOutlined, FileDoneOutlined,
...
export default {
  ...
  components: { CopyOutlined, PicRightOutlined, FileDoneOutlined ,DownloadOutlined,
