    ...
    <template #title>
      <div style="display: flex; align-items: center; justify-content: space-between; padding: 0;">
        <div style="display: flex; align-items: center;">
         ...
         <span className=" pr-2 sm:text-[18px]" style=" font-weight: 600; color: #1f2937;">Add <span v-if="LightType=='sunk'">Sunk</span><span v-else>Un-Sunk</span> Magnetic Light </span>
        </div>
