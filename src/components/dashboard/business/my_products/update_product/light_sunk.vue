  ...
  <div>
    ...
    >
      <div style="display: flex; align-items: center">
        ...
        >
          Edit {{ selectedProduct.category?.name || "Product" }}
        </h2>
      </div>
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      ...
      if (
        this.productForm.stock.quantity !== null &&
        this.productForm.stock.quantity < 0
      ) {
      ...
      for (let field of dimensionFields) {
        if (
          this.productForm.dimensions[field] !== null &&
          parseFloat(this.productForm.dimensions[field]) <= 0
        ) {
