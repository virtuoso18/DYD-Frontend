  ...
  <div>
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; padding: 0 10px;">
      <div style="display: flex; align-items: center;">
        ...
        <h2 style="margin: 0; font-size: 20px; font-weight: 600; color: #1f2937;">Edit Wall Texture</h2>
      </div>
    ...
    <a-row style="padding: 0 24px;">
      ...
      <a-col :span="24">
        <div style="padding-left: 24px; border-left: 1px solid #f3f4f6;">
          <h3 style="margin-bottom: 24px; font-weight: 600; font-size: 16px; color: #1f2937;">Wall Texture Details</h3>
    ...
    async saveTexture() {
      ...
      try {
        ...
        if (result.success) {
          ...
          this.$message.error(result.message || 'Failed to update wall texture');
        }
