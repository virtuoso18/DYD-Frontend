...
</svg>                        <a-input :disabled="!isEditMode" v-model:value="businessInfo.whatsapp" addon-before="https://wa.me/" class="social-input" />
                      </div>
                      <div class="social-input-group">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_7512_27623)">
...
</svg>                        <a-input :disabled="!isEditMode" v-model:value="businessInfo.facebook" addon-before="https://facebook.com/" class="social-input" />
                      </div>
...
export default {
  ...
  data() {
    return {
      ...
      avatar: this.buisness_info?.banner_picture ? (this.$store.state.root_media_api + this.buisness_info.banner_picture) : "",
      business_picture: this.buisness_info?.business_picture || "",
      description: this.buisness_info?.description || "",
      services: this.buisness_info?.services || "",
      whatsapp: this.buisness_info?.whatsapp_number ? ('https://wa.me/' + this.buisness_info.whatsapp_number) : "",
      instagram: this.buisness_info?.instagram_url ? ('https://instagram.com/' + this.buisness_info.instagram_url) : "",
      facebook: this.buisness_info?.facebook_url ? ('https://facebook.com/' + this.buisness_info.facebook_url) : "",
      website: this.buisness_info?.website_url ? ('https://' + this.buisness_info.website_url) : "",
      cartLink: 'https://',
    ...
    otpProgress: 100,
      ...
      editServices: false,
      editData: {
        servicesTitle: 'what does your business offer ?',
        services: [
      ...
      try {
        ...
        if (result.success) {
          ...
          this.editData = {
            ...this.editData,
            servicesTitle: 'What does your business offer?',
            services: Array.isArray(data.services_offered) ?  data.services_offered : this.editData.services 
          };
