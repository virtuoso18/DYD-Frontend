      ...
      <a-col :span="24">
        <div style="padding-left: 24px; border-left: 1px solid #f3f4f6;">
          ...
          <div style="margin-bottom: 24px;">
            ...
            <a-row :gutter="16">
              <a-col :span="6" v-for="dim in ['height', 'length', 'width', 'depth']" :key="dim">
                <label style="display: block; margin-bottom: 6px; font-weight: 500; font-size: 13px; color: #6b7280; text-transform: capitalize;">{{ dim }}</label>
                <div style="display: flex; align-items: center;">
                  <a-input v-model:value="productForm.dimensions[dim]" :placeholder="dim === 'height' ? '100' : '30'" style="border-radius: 6px;" />
                  <span style="margin-left: 8px; color: #9ca3af; font-size: 13px; min-width: 20px;">cm</span>
                </div>
              </a-col>
            </a-row>
          </div>
