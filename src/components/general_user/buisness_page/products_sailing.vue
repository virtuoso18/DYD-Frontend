          ...
          <div class="p-2.5 mb-2.5 rounded-xl bg-gray-100">
            ...
            >
              ...
              <img
                ...
                class="w-full h-[240px] object-cover rounded-[10px] transition-transform duration-300 ease-in-out"
              />
            ...
            <div class="space-y-1.5">
              <!-- Title -->
              <div class="w-full">
                <b class="block w-full truncate font-medium text-sm" :title="product.product_title">
