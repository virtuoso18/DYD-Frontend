...
/>
                 ...
                 <br>
                 <a-button type="primary" block @click="this.$router.push('/ar-product/' + selectedProduct.id)" style="display:flex;justify-content: center;align-items: center;gap:10px;color:white">
