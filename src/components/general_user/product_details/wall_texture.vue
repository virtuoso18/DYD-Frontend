      ...
      <a-col :xs="24" :md="12">
        <a-card>
          ...
          <a-tag color="blue" style="margin-bottom: 16px;">
            {{ selectedTexture.texture_owner_display ? 'Wall' : 'Floor' }} Texture Details
          </a-tag>
          ...
          <div style="margin-bottom: 20px;">
            ...
            <span v-if="selectedTexture.size_width"  style="font-weight:bold"> {{ selectedTexture.size_width }} m in W X&nbsp;</span> 
          <span v-if="selectedTexture.size_width" style="font-weight:bold" > {{ selectedTexture.size_width }} m in H X&nbsp;</span>  
