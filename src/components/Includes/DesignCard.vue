  ...
  {{ views }}
    ...
    <div class="px-3 py-2 flex items-center justify-between">
      ...
      <div class="flex items-center gap-2">
        ...
        />
<span class="!font-poppins font-normal text-[12px] sm:text-[14px] leading-[20px] tracking-normal text-center text-gray-600">
  {{ name }}
</span>
      </div>
  ...
  class="flex !text-[12px] sm:!text-[16px] items-center gap-1"
>
...
<div 
  ...
  class="flex items-center !text-[12px] sm:!text-[16px] gap-1 cursor-pointer"
  @click="toggleLike"
>
