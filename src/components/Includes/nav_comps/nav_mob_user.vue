...
<path d="M6.59961 17.3767C6.71544 18.5542 6.97721 19.3468 7.56883 19.9384C8.62997 20.9996 10.3378 20.9996 13.7536 20.9996C17.1694 20.9996 18.8773 20.9996 19.9384 19.9384C20.9996 18.8773 20.9996 17.1694 20.9996 13.7536C20.9996 10.3378 20.9996 8.62997 19.9384 7.56883C19.3468 6.97721 18.5542 6.71544 17.3767 6.59961" stroke="currentColor"/>
<path d="M3 10.2C3 6.80588 3 5.10883 4.05441 4.05441C5.10883 3 6.80588 3 10.2 3C13.5941 3 15.2912 3 16.3456 4.05441C17.4 5.10883 17.4 6.80588 17.4 10.2C17.4 13.5941 17.4 15.2912 16.3456 16.3456C15.2912 17.4 13.5941 17.4 10.2 17.4C6.80588 17.4 5.10883 17.4 4.05441 16.3456C3 15.2912 3 13.5941 3 10.2Z" stroke="currentColor"/>
<path d="M5.69922 17.3992C8.77777 13.123 12.2374 7.45193 17.3992 11.7052" stroke="currentColor"/>
</svg>
...
<script>
export default {
    name:"general_user_nav_drawar_menu"
} 
</script> -->

<template>
  <div>
    <!-- My Designs Button (instead of My Store) -->
    <div class="pb-2">
      <button 
        @click="navigateToMyDesigns"
        class="w-full bg-[#3B63FB] !font-family-poppins from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 !text-white font-semibold py-2 px-3 rounded-xl flex items-center justify-center gap-3 transition-all duration-300 transform hover:-translate-y-0.5"
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M6.59961 17.3767C6.71544 18.5542 6.97721 19.3468 7.56883 19.9384C8.62997 20.9996 10.3378 20.9996 13.7536 20.9996C17.1694 20.9996 18.8773 20.9996 19.9384 19.9384C20.9996 18.8773 20.9996 17.1694 20.9996 13.7536C20.9996 10.3378 20.9996 8.62997 19.9384 7.56883C19.3468 6.97721 18.5542 6.71544 17.3767 6.59961" stroke="white"/>
          <path d="M3 10.2C3 6.80588 3 5.10883 4.05441 4.05441C5.10883 3 6.80588 3 10.2 3C13.5941 3 15.2912 3 16.3456 4.05441C17.4 5.10883 17.4 6.80588 17.4 10.2C17.4 13.5941 17.4 15.2912 16.3456 16.3456C15.2912 17.4 13.5941 17.4 10.2 17.4C6.80588 17.4 5.10883 17.4 4.05441 16.3456C3 15.2912 3 13.5941 3 10.2Z" stroke="white"/>
          <path d="M5.69922 17.3992C8.77777 13.123 12.2374 7.45193 17.3992 11.7052" stroke="white"/>
        </svg>
    ...
    <nav class=" pb-6 space-y-1">
      ...
      <router-link 
        ...
        :class="{ 'nav-active': $route.name === 'user_my_profile' }" 
        @click="closeMobileMenu"
      >
        <div class="flex-shrink-0 w-7 h-7 rounded-lg  flex items-center justify-center transition-all duration-200 group-hover:bg-blue-100">
         <svg
          width="17"
          height="17"
          viewBox="0 0 17 17"
        ...
        <span class="flex-1 text-[#333333] text-sm !font-family-poppins">Profile</span>
      ...
      <router-link 
        ...
        :class="{ 'nav-active': $route.name === 'user_my_designs' }" 
        @click="closeMobileMenu"
      >
        <div class="flex-shrink-0 w-7 h-7 rounded-lg  flex items-center justify-center transition-all duration-200 group-hover:bg-blue-100">
          <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#333333">
            <path d="M6.59961 17.3767C6.71544 18.5542 6.97721 19.3468 7.56883 19.9384C8.62997 20.9996 10.3378 20.9996 13.7536 20.9996C17.1694 20.9996 18.8773 20.9996 19.9384 19.9384C20.9996 18.8773 20.9996 17.1694 20.9996 13.7536C20.9996 10.3378 20.9996 8.62997 19.9384 7.56883C19.3468 6.97721 18.5542 6.71544 17.3767 6.59961"/>
            <path d="M3 10.2C3 6.80588 3 5.10883 4.05441 4.05441C5.10883 3 6.80588 3 10.2 3C13.5941 3 15.2912 3 16.3456 4.05441C17.4 5.10883 17.4 6.80588 17.4 10.2C17.4 13.5941 17.4 15.2912 16.3456 16.3456C15.2912 17.4 13.5941 17.4 10.2 17.4C6.80588 17.4 5.10883 17.4 4.05441 16.3456C3 15.2912 3 13.5941 3 10.2Z"/>
            <path d="M5.69922 17.3992C8.77777 13.123 12.2374 7.45193 17.3992 11.7052"/>
          </svg>
        </div>
        <span class="flex-1 text-[#333333] text-sm !font-family-poppins">My Designs</span>
        <svg class="w-5 h-5 opacity-0 transform -translate-x-2 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 18l6-6-6-6"/>
        </svg>
      </router-link>
      ...
      <router-link 
        to="/user-dashboard/my-requests" 
        class="flex items-center gap-4 px-2 py-2 rounded-xl text-gray-700 font-medium transition-all duration-200 relative overflow-hidden group hover:bg-gray-50 hover:text-blue-600"
        :class="{ 'nav-active': $route.name === 'user_my_requests' }" 
        @click="closeMobileMenu"
      >
        <div class="flex-shrink-0 w-7 h-7 rounded-lg  flex items-center justify-center transition-all duration-200 group-hover:bg-blue-100">
          <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#333333">
        ...
        <span class="flex-1 text-[#333333] text-sm !font-family-poppins">Requests</span>
        <svg class="w-5 h-5 opacity-0 transform -translate-x-2 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 18l6-6-6-6"/>
        </svg>
      </router-link>
      ...
      >
        <div class="flex-shrink-0 w-7 h-7 rounded-lg  flex items-center justify-center transition-all duration-200 group-hover:bg-blue-100">
          <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#333333">
            <path d="M20 10H4L9.5 4M4 14H20L14.5 20" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </div>
        <span class="flex-1 text-[#333333] text-sm !font-family-poppins">My Likes</span>
        <svg class="w-5 h-5 opacity-0 transform -translate-x-2 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 18l6-6-6-6"/>
        </svg>
      </router-link>
      ...
      <router-link 
        to="/user-dashboard/my-messages" 
        class="flex items-center gap-4 px-2 py-2 rounded-xl text-gray-700 font-medium transition-all duration-200 relative overflow-hidden group hover:bg-gray-50 hover:text-blue-600"
        :class="{ 'nav-active': $route.name === 'user_my_messages' }" 
        @click="closeMobileMenu"
      >
        <div class="flex-shrink-0 w-7 h-7 rounded-lg  flex items-center justify-center transition-all duration-200 group-hover:bg-blue-100">
          <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#333333">
            <path d="M9.19992 13.4739H14.8001M9.19992 9.52659H12M13.736 18.5186C17.0833 18.2999 19.749 15.6315 19.9682 12.2818C20.0106 11.6266 20.0106 10.9476 19.9682 10.2924C19.749 6.94346 17.0833 4.27665 13.736 4.05639C12.5799 3.9812 11.4201 3.9812 10.2639 4.05639C6.91666 4.27586 4.25099 6.94346 4.03178 10.2932C3.98941 10.9557 3.98941 11.6201 4.03178 12.2826C4.11179 13.5023 4.6582 14.6321 5.30222 15.5857C5.67583 16.2528 5.42942 17.0857 5.03981 17.8144C4.7598 18.3394 4.619 18.6015 4.7318 18.791C4.84381 18.9804 5.09581 18.9868 5.59903 18.9986C6.59505 19.0223 7.26627 18.7444 7.79908 18.3568C8.10069 18.1365 8.25189 18.0268 8.3559 18.0141C8.4599 18.0015 8.6655 18.0852 9.07512 18.251C9.44313 18.401 9.87114 18.4933 10.2631 18.5194C11.4032 18.5936 12.5944 18.5936 13.7368 18.5194" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </div>
        <span class="flex-1 text-[#333333] text-sm !font-family-poppins">Messages</span>
        <svg class="w-5 h-5 opacity-0 transform -translate-x-2 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 18l6-6-6-6"/>
        </svg>
      </router-link>
      ...
      <!-- <router-link 
        to="/user-dashboard/manage-subscription" 
        class="flex items-center gap-4 px-2 py-2 rounded-xl text-gray-700 font-medium transition-all duration-200 relative overflow-hidden group hover:bg-gray-50 hover:text-blue-600"
        :class="{ 'nav-active': $route.name === 'user_manage_subscription' }" 
        @click="closeMobileMenu"
      >
        <div class="flex-shrink-0 w-7 h-7 rounded-lg bg-gray-100 flex items-center justify-center transition-all duration-200 group-hover:bg-blue-100">
          <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            <path d="M7.94 10.945H16.56M7.94 10.945H3M7.94 10.945L11.59 20.996M7.94 10.945L10.34 7.012L10.89 6M16.56 10.945H21.5M16.56 10.945L12.91 20.996M16.56 10.945L14.16 7.012L13.594 6M3 10.945C3 11.365 3.079 11.785 3.236 12.181C3.448 12.716 3.878 13.209 4.736 14.194L8.203 18.17C9.6 19.772 10.298 20.574 11.126 20.868C11.2787 20.922 11.4333 20.9647 11.59 20.996M3 10.945C3 10.525 3.079 10.105 3.236 9.708C3.448 9.173 3.878 8.681 4.736 7.695C5.203 7.161 5.436 6.894 5.706 6.687C6.10742 6.38107 6.5726 6.1695 7.067 6.068C7.401 6 7.755 6 8.464 6H10.89M11.59 20.996C12.0258 21.0822 12.4742 21.0822 12.91 20.996M10.89 6H13.594M21.5 10.945C21.5 11.365 21.421 11.785 21.264 12.181C21.052 12.716 20.622 13.209 19.764 14.194L16.297 18.17C14.9 19.772 14.202 20.574 13.374 20.868C13.2226 20.9216 13.0675 20.9643 12.91 20.996M21.5 10.945C21.5 10.525 21.421 10.105 21.264 9.708C21.052 9.173 20.622 8.681 19.764 7.695C19.297 7.161 19.064 6.894 18.794 6.687C18.3926 6.38107 17.9274 6.1695 17.433 6.068C17.099 6 16.745 6 16.036 6H13.594" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </div>
      ...
      <div 
        ...
        @click="navigateToBusinessAccess"
      >
        <div class="flex-shrink-0 w-7 h-7 rounded-lg bg-gray-100 flex items-center justify-center transition-all duration-200 group-hover:bg-blue-100">
          <svg class="w-5 h-5" viewBox="0 0 512 512" fill="currentColor">
            <path d="M368.475,68.426H246.688c-5.667,0-10.262,4.594-10.262,10.262s4.596,10.262,10.262,10.262h121.787c5.667,0,10.262-4.594,10.262-10.262S374.141,68.426,368.475,68.426z"/>
            <path d="M185.236,88.951h4.105c5.667,0,10.262-4.594,10.262-10.262s-4.596-10.262-10.262-10.262h-4.105c-5.667,0-10.262,4.594-10.262,10.262S179.569,88.951,185.236,88.951z"/>
          </svg>
        </div>
        <span class="flex-1 text-sm !font-family-poppins">Access Business</span>
        <svg class="w-5 h-5 opacity-0 transform -translate-x-2 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 18l6-6-6-6"/>
        </svg>
      </div>
      ...
      <router-link 
        to="/user-dashboard/my-settings" 
        class="flex items-center gap-4 px-2 py-2 rounded-xl text-gray-700 font-medium transition-all duration-200 relative overflow-hidden group hover:bg-gray-50 hover:text-blue-600"
        :class="{ 'nav-active': $route.name === 'user_settings' }" 
        @click="closeMobileMenu"
      >
        <div class="flex-shrink-0 w-7 h-7 rounded-lg  flex items-center justify-center transition-all duration-200 group-hover:bg-blue-100">
          <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#333333">
            <path d="M12.5 14.0909C13.9309 14.0909 15.0909 12.9309 15.0909 11.5C15.0909 10.0691 13.9309 8.90909 12.5 8.90909C11.0691 8.90909 9.90909 10.0691 9.90909 11.5C9.90909 12.9309 11.0691 14.0909 12.5 14.0909Z" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M18.8909 14.0909C18.7759 14.3514 18.7417 14.6403 18.7925 14.9205C18.8432 15.2007 18.9768 15.4592 19.1759 15.6627L19.2277 15.7145C19.3883 15.875 19.5157 16.0655 19.6026 16.2751C19.6896 16.4848 19.7343 16.7096 19.7343 16.9366C19.7343 17.1636 19.6896 17.3883 19.6026 17.598C19.5157 17.8077 19.3883 17.9982 19.2277 18.1586C19.0673 18.3192 18.8768 18.4466 18.6671 18.5336C18.4574 18.6205 18.2327 18.6652 18.0057 18.6652C17.7787 18.6652 17.5539 18.6205 17.3442 18.5336C17.1346 18.4466 16.9441 18.3192 16.7836 18.1586L16.7318 18.1068C16.5283 17.9077 16.2698 17.7742 15.9896 17.7234C15.7094 17.6726 15.4205 17.7069 15.16 17.8218C14.9046 17.9313 14.6867 18.1131 14.5333 18.3448C14.3798 18.5765 14.2975 18.848 14.2964 19.1259V19.2727C14.2964 19.7308 14.1144 20.1702 13.7905 20.4941C13.4665 20.818 13.0272 21 12.5691 21C12.111 21 11.6717 20.818 11.3477 20.4941C11.0238 20.1702 10.8418 19.7308 10.8418 19.2727V19.195C10.8351 18.9091 10.7426 18.6319 10.5763 18.3993C10.4099 18.1668 10.1775 17.9896 9.90909 17.8909C9.6486 17.7759 9.35965 17.7417 9.07949 17.7925C8.79933 17.8432 8.54081 17.9768 8.33727 18.1759L8.28545 18.2277C8.12504 18.3883 7.93454 18.5157 7.72485 18.6026C7.51516 18.6896 7.2904 18.7343 7.06341 18.7343C6.83642 18.7343 6.61165 18.6896 6.40197 18.6026C6.19228 18.5157 6.00178 18.3883 5.84136 18.2277C5.68077 18.0673 5.55337 17.8768 5.46644 17.6671C5.37952 17.4574 5.33478 17.2327 5.33478 17.0057C5.33478 16.7787 5.37952 16.5539 5.46644 16.3442C5.55337 16.1346 5.68077 15.9441 5.84136 15.7836L5.89318 15.7318C6.09228 15.5283 6.22584 15.2698 6.27664 14.9896C6.32744 14.7094 6.29314 14.4205 6.17818 14.16C6.0687 13.9046 5.88693 13.6867 5.65522 13.5333C5.42351 13.3798 5.152 13.2975 4.87409 13.2964H4.72727C4.26917 13.2964 3.82983 13.1144 3.50591 12.7905C3.18198 12.4665 3 12.0272 3 11.5691C3 11.111 3.18198 10.6717 3.50591 10.3477C3.82983 10.0238 4.26917 9.84182 4.72727 9.84182H4.805C5.09086 9.83513 5.3681 9.7426 5.60067 9.57626C5.83324 9.40992 6.01039 9.17745 6.10909 8.90909C6.22405 8.6486 6.25835 8.35965 6.20755 8.07949C6.15675 7.79933 6.02319 7.54081 5.82409 7.33727L5.77227 7.28545C5.61168 7.12504 5.48428 6.93454 5.39735 6.72485C5.31043 6.51516 5.26569 6.2904 5.26569 6.06341C5.26569 5.83642 5.31043 5.61165 5.39735 5.40197C5.48428 5.19228 5.61168 5.00178 5.77227 4.84136C5.93269 4.68077 6.12319 4.55337 6.33288 4.46644C6.54256 4.37952 6.76733 4.33478 6.99432 4.33478C7.22131 4.33478 7.44607 4.37952 7.65576 4.46644C7.86545 4.55337 8.05595 4.68077 8.21636 4.84136L8.26818 4.89318C8.47172 5.09228 8.73024 5.22584 9.0104 5.27664C9.29056 5.32744 9.57951 5.29314 9.84 5.17818H9.90909C10.1645 5.0687 10.3824 4.88693 10.5358 4.65522C10.6893 4.42351 10.7716 4.152 10.7727 3.87409V3.72727C10.7727 3.26917 10.9547 2.82983 11.2786 2.50591C11.6026 2.18198 12.0419 2 12.5 2C12.9581 2 13.3974 2.18198 13.7214 2.50591C14.0453 2.82983 14.2273 3.26917 14.2273 3.72727V3.805C14.2284 4.08291 14.3107 4.35442 14.4642 4.58613C14.6176 4.81783 14.8355 4.99961 15.0909 5.10909C15.3514 5.22405 15.6403 5.25835 15.9205 5.20755C16.2007 5.15675 16.4592 5.02319 16.6627 4.82409L16.7145 4.77227C16.875 4.61168 17.0655 4.48428 17.2751 4.39735C17.4848 4.31043 17.7096 4.26569 17.9366 4.26569C18.1636 4.26569 18.3883 4.31043 18.598 4.39735C18.8077 4.48428 18.9982 4.61168 19.1586 4.77227C19.3192 4.93269 19.4466 5.12319 19.5336 5.33288C19.6205 5.54256 19.6652 5.76733 19.6652 5.99432C19.6652 6.22131 19.6205 6.44607 19.5336 6.65576C19.4466 6.86545 19.3192 7.05595 19.1586 7.21636L19.1068 7.26818C18.9077 7.47172 18.7742 7.73024 18.7234 8.0104C18.6726 8.29056 18.7069 8.57951 18.8218 8.84V8.90909C18.9313 9.16453 19.1131 9.38238 19.3448 9.53583C19.5765 9.68927 19.848 9.77162 20.1259 9.77273H20.2727C20.7308 9.77273 21.1702 9.95471 21.4941 10.2786C21.818 10.6026 22 11.0419 22 11.5C22 11.9581 21.818 12.3974 21.4941 12.7214C21.1702 13.0453 20.7308 13.2273 20.2727 13.2273H20.195C19.9171 13.2284 19.6456 13.3107 19.4139 13.4642C19.1822 13.6176 19.0004 13.8355 18.8909 14.0909Z" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </div>
...
>
  ...
  >
    ...
    />
      ...
      >
        <div class="flex-shrink-0 w-7 h-7 rounded-lg bg-red-50 flex items-center justify-center transition-all duration-200 group-hover:bg-red-100">
...
export default {
  ...
  props: {
    ...
    employee_owner_business_slug: {
      type: String,
      default: ''
    },
    employee_owner_business_access_id: {
      type: String,
      default: ''
    }
  },
  ...
  methods: {
    ...
    navigateToMyDesigns() {
      this.$router.push({ name: 'user_my_designs' })
      this.closeMobileMenu()
    },

    navigateToBusinessAccess() {
      this.$router.push({
        name: 'business-overview',
