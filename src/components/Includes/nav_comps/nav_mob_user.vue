  ...
  <div>
    ...
    <div class="pb-2">
      ...
      >
        ...
        <span>{{ t('user_dashboard.myDesigns') }}</span>
      </button>
    </div>
    ...
    <nav class="pb-6 space-y-1">
      ...
      >
        ...
        <span class="flex-1 text-[#333333] text-sm !font-family-poppins">{{ t('user_dashboard.profile') }}</span>
        <svg class="w-5 h-5 opacity-0 transform -translate-x-2 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="#333333" viewBox="0 0 24 24">
      ...
      >
        ...
        <span class="flex-1 text-[#333333] text-sm !font-family-poppins">{{ t('user_dashboard.myDesigns') }}</span>
        <svg class="w-5 h-5 opacity-0 transform -translate-x-2 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="#333333" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 18l6-6-6-6"/>
        </svg>
      </router-link>
      ...
      >
        ...
        <span class="flex-1 text-[#333333] text-sm !font-family-poppins">{{ t('user_dashboard.requests') }}</span>
        <svg class="w-5 h-5 opacity-0 transform -translate-x-2 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="#333333" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 18l6-6-6-6"/>
        </svg>
      </router-link>
      ...
      >
        ...
        <span class="flex-1 text-[#333333] text-sm !font-family-poppins">{{ t('user_dashboard.myLikes') }}</span>
        <svg class="w-5 h-5 opacity-0 transform -translate-x-2 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="#333333" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 18l6-6-6-6"/>
        </svg>
      </router-link>
      ...
      >
        ...
        <span class="flex-1 text-[#333333] text-sm !font-family-poppins">{{ t('user_dashboard.messages') }}</span>
        <svg class="w-5 h-5 opacity-0 transform -translate-x-2 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="#333333" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 18l6-6-6-6"/>
        </svg>
      </router-link>
      ...
      >
        ...
        <span class="flex-1 text-[#333333] text-sm !font-family-poppins">{{ t('user_dashboard.accessBusiness') }}</span>
        <svg class="w-5 h-5 opacity-0 transform -translate-x-2 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="#333333" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 18l6-6-6-6"/>
        </svg>
      </div>
      ...
      >
        ...
        <span class="flex-1 text-sm text-[#333333] !font-family-poppins">{{ t('user_dashboard.settings') }}</span>
        <svg class="w-5 h-5 opacity-0 transform -translate-x-2 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="#333333" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 18l6-6-6-6"/>
        </svg>
      </router-link>
      ...
      >
        <div class="flex-shrink-0 w-7 h-7 rounded-lg flex items-center justify-center transition-all duration-200 group-hover:bg-blue-100">
          <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#333333">
            <path d="M3 5h18v10H5l-2 2V5z" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </div>
        <span class="flex-1 text-sm text-[#333333] !font-family-poppins">{{ t('user_dashboard.contactUs') }}</span>
        <svg class="w-5 h-5 opacity-0 transform -translate-x-2 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="#333333" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 18l6-6-6-6"/>
        </svg>
      </router-link>
      ...
      >
        ...
        <span class="flex-1 text-sm !font-family-poppins">{{ t('user_dashboard.logout') }}</span>
        <svg class="w-5 h-5 opacity-0 transform -translate-x-2 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="#333333" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 18l6-6-6-6"/>
        </svg>
      </button>
