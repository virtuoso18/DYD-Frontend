...
<template>
  <div>
    ...
    <nav class="px-1 pb-6 space-y-1">
      ...
      >
        <div class="flex-shrink-0 w-10 h-10 rounded-lg  flex items-center justify-center transition-all duration-200 group-hover:bg-blue-100">
         <svg
          width="17"
          height="17"
          viewBox="0 0 17 17"
      ...
      >
        <div class="flex-shrink-0 w-10 h-10 rounded-lg bg-red-50 flex items-center justify-center transition-all duration-200 group-hover:bg-red-100">
