    ...
    >
      <div>
        ...
        <p style="margin: 4px 0 0 0; color: #6b7280; font-size: 12px">
          Create and manage your custom banners
        </p>
      </div>
      ...
      >
        ...
        >
          <div
            ...
            :style="{
              ...
              transition: 'all 0.2s',
              background:
                selectedAspectRatio === 'all' ? '#3B63FB' : 'transparent',
          ...
          <div
            ...
            :style="{
              ...
              transition: 'all 0.2s',
              background:
                selectedAspectRatio === '1:1' ? '#3B63FB' : 'transparent',
          ...
          >
            ...
            >
              <rect
                ...
                height="13"
                rx="2.5"
                :stroke="selectedAspectRatio === '1:1' ? 'white' : '#6b7280'"
              />
            </svg>
            <span>1:1</span>
            <span
              v-if="selectedAspectRatio === '1:1'"
              style="
                background: rgba(255, 255, 255, 0.3);
                padding: 2px 6px;
                border-radius: 4px;
            ...
            >
              {{
                myBanners.filter((b) => getBannerRatio(b.banner) === "1:1")
                  .length
              }}
            </span>
          </div>
          ...
          <div
            ...
            :style="{
              ...
              transition: 'all 0.2s',
              background:
                selectedAspectRatio === '3:2' ? '#3B63FB' : 'transparent',
          ...
          >
            ...
            >
              <rect
                ...
                height="13"
                rx="2.5"
                :stroke="selectedAspectRatio === '3:2' ? 'white' : '#6b7280'"
              />
            </svg>
            <span>3:2</span>
            <span
              v-if="selectedAspectRatio === '3:2'"
              style="
                background: rgba(255, 255, 255, 0.3);
                padding: 2px 6px;
                border-radius: 4px;
            ...
            >
              {{
                myBanners.filter((b) => getBannerRatio(b.banner) === "3:2")
                  .length
              }}
            </span>
          </div>
          ...
          <div
            ...
            :style="{
              ...
              transition: 'all 0.2s',
              background:
                selectedAspectRatio === '2:3' ? '#3B63FB' : 'transparent',
          ...
          >
            ...
            >
              <rect
                ...
                height="15"
                rx="2.5"
                :stroke="selectedAspectRatio === '2:3' ? 'white' : '#6b7280'"
              />
            </svg>
            <span>2:3</span>
            <span
              v-if="selectedAspectRatio === '2:3'"
              style="
                background: rgba(255, 255, 255, 0.3);
                padding: 2px 6px;
                border-radius: 4px;
            ...
            >
              {{
                myBanners.filter((b) => getBannerRatio(b.banner) === "2:3")
                  .length
              }}
            </span>
          </div>
        ...
        >
          <template #icon>
            ...
            >
              <path
                d="M8.0026 5.83203V11.1654M10.6693 8.4987H5.33594"
                stroke="white"
                stroke-width="1.5"
    ...
    <a-spin :spinning="loadingBanners || loadingMyBanners">
      <a-row :gutter="[16, 16]">
        ...
        <a-col
          ...
          :md="8"
          :lg="8"
          v-for="banner in filteredMyBanners"
          :key="banner.id"
        >
          <div
            style="
          ...
          >
            <div class="banner-image-sec">
              <img
                :src="this.$store.state.root_media_api + banner.final_banner"
            ...
            <div style="padding: 12px">
              ...
              <div style="display: flex; gap: 6px; margin-top: 8px">
                ...
                <a-button
                  danger
                  size="medium"
                  @click="deleteMyBanner(banner.id)"
                  style="
                    display: flex;
                    justify-content: center;
                    align-items: center;
      ...
      <!-- Empty State -->
      <div
        v-if="filteredMyBanners.length === 0 && !loadingMyBanners"
        style="
          text-align: center;
          padding: 60px 20px;
          background: #f9fafb;
      ...
      >
        ...
        >
          &lt;a href="{{
            ...
            selectedBanner.business_slug
          }}"&gt; &lt;img src="{{ shortenUrl(selectedBanner.final_banner) }}"
          alt="" srcset="" /&gt; &lt; /a &gt;
        </div>
      ...
      <div v-if="currentStep === 0">
        <a-row>
          <a-col :xs="24" :sm="24" :md="24" :lg="6">
            ...
            >
              <a-button
                @click="selectRatioForCreation('1:1')"
                type="text"
                size="medium"
                style="
                  display: flex;
              ...
              <a-button
                ...
                style="
                  ...
                  align-items: center;
                "
                @click="selectRatioForCreation('3:2')"
              >
                <svg
                  width="19"
                  height="14"
              ...
              <a-button
                ...
                style="
                  ...
                  align-items: center;
                "
                @click="selectRatioForCreation('2:3')"
              >
                <svg
                  width="11"
                  height="16"
          ...
          <a-col :xs="24" :sm="24" :md="24" :lg="18">
            <div>
              ...
              >
                ...
                >
                  <a-empty
                    description="There is no banner available with this aspect ratio."
                  ></a-empty>
                </div>
                <a-col
                  :xs="24"
                  ...
                  >
                    ...
                    <div style="padding: 10px; text-align: center">
                      ...
                      <div
                        ...
                        style="margin-top: 4px; color: #10b981; font-size: 16px"
                      >
                        ✓
                      </div>
                    </div>
          ...
          <a-row :gutter="{ lg: 16 }">
            ...
            <a-col :xs="24" :sm="24" :md="24" :lg="6">
              ...
              >
                ...
                <div
                  v-if="
                    selectedElementType === 'text' && selectedTextIndex !== null
                  "
                ...
                >
                  ...
                  >
                    <div style="margin-bottom: 12px">
                      ...
                      <a-textarea
                        v-model:value="
                          workingTextElements[selectedTextIndex].content
                        "
                    ...
                    <div style="margin-bottom: 12px">
                      ...
                      >
                        Font Size:
                        {{ workingTextElements[selectedTextIndex].fontSize }}px
                      </label>
                      <a-slider
                        v-model:value="
                          workingTextElements[selectedTextIndex].fontSize
                        "
                        :min="12"
                        :max="120"
                ...
                >
                  ...
                  >
                    <div style="margin-bottom: 12px">
                      ...
                      <div
                        v-if="
                          workingMaskAreas[selectedWorkingMaskIndex]
                            .productPreview
                        "
                        style="
                          width: 100%;
                    ...
                    <div
                      v-if="
                        workingMaskAreas[selectedWorkingMaskIndex].productImg
                      "
                    ...
                    >
                      ...
                      >
                        ...
                        {{
                          Math.round(
                            workingMaskAreas[selectedWorkingMaskIndex].transform
                              .scale * 100,
                          )
                        }}%
                      </label>
              ...
              <div style="display: flex; gap: 8px; margin-top: 16px">
                <a-button @click="currentStep = 0" style="flex: 1"
                  >← Back</a-button
                >
                <a-button type="primary" @click="nextStep" style="flex: 2"
                  >Preview →</a-button
                >
              </div>
            </a-col>
            ...
            <a-col :xs="24" :sm="24" :md="24" :lg="18">
              <div class="left-pannel-canvas-container">
                <div v-if="workingBannerImg" class="canvas-parent">
                  <canvas
                    ref="workingCanvas"
                  ...
                  <!-- Text Click Areas -->
                  <div
                    v-for="(text, index) in workingTextElements"
                    :key="`text-area-${index}`"
                ...
                "
              >
                💡 Click text to edit • Click product area to upload/adjust •
                Drag products to move
                <br />
      ...
      <div v-if="currentStep === 2">
        <div style="text-align: center">
          ...
          <div style="display: flex; gap: 12px; justify-content: center">
            <a-button @click="handlePreviewBack" size="large"
              >← Back to Edit</a-button
            >
            <a-button
              type="primary"
              size="large"
...
export default {
  ...
  computed: {
    filteredMyBanners() {
      ...
      return this.myBanners.filter(
        (b) => this.getBannerRatio(b.banner) === this.selectedAspectRatio,
      );
    },

    filteredTemplates() {
      if (!this.creationAspectRatio) return this.templateBanners;
      return this.templateBanners.filter(
        (b) => b.ratio === this.creationAspectRatio,
      );
    },
  },
  ...
  methods: {
    ...
    handleProductZoomChange() {
      ...
      const centerX =
        mask.transform.x + (mask.transform.width * mask.transform.scale) / 2;
      const centerY =
        mask.transform.y + (mask.transform.height * mask.transform.scale) / 2;

      mask.transform.x =
        centerX - (mask.transform.width * mask.transform.scale) / 2;
      mask.transform.y =
        centerY - (mask.transform.height * mask.transform.scale) / 2;
    ...
    resetProductPosition() {
      ...
      const scaleY =
        (mask.maskBounds.height * padding) / mask.productImg.height;
    ...
    async fetchMyBanners() {
      ...
      try {
        const response = await fetch(
          `${this.$store.state.root_api}access-engine/api/generate-banner/my-banners/?access-id=` +
      ...
      try {
        ...
        if (data.success) {
          this.templateBanners = data.data.map((banner) => ({
            ...
            banner_image:
              this.$store.state.root_media_api + banner.banner_image,
            ratio: banner.ratio,
      ...
      try {
        ...
        if (data.success) {
          ...
          this.workingTextElements =
            typeof fullBanner.text_data === "string"
              ? JSON.parse(fullBanner.text_data || "[]")
              : fullBanner.text_data || [];

          // Load banner image FIRST
          await this.loadWorkingBannerImage(
            this.$store.state.root_media_api + fullBanner.banner_image,
          );
    ...
    calculateMaskBounds(maskImg) {
      ...
      ctx.drawImage(
        ...
        0,
        0,
        this.workingCanvasWidth,
        this.workingCanvasHeight,
      );
    ...
    /* initWorkingCanvas() {
     ...
     //// canvas.style.width =
       // Math.round(this.workingCanvasWidth * this.workingDisplayScale) + "px";
      //canvas.style.height =
        //Math.round(this.workingCanvasHeight * this.workingDisplayScale) + "px";
    ...
    initWorkingCanvas() {
      const canvas = this.$refs.workingCanvas;
      if (!canvas || !this.workingBannerImg) return;
    ...
    updateWorkingCanvas() {
      ...
      this.workingMaskAreas.forEach((mask) => {
        ...
        const productData = productCtx.getImageData(
          0,
          0,
          canvas.width,
          canvas.height,
    ...
    selectWorkingMask(index) {
      this.selectedWorkingMaskIndex =
        this.selectedWorkingMaskIndex === index ? null : index;
    },
    ...
    handleWorkingMouseMove(e) {
      if (!this.isDraggingWorking || this.selectedWorkingMaskIndex === null)
        return;
    ...
    async saveGeneratedBanner() {
      try {
        ...
        if (!this.previewBanner) {
          this.$message.error(
            "Preview not found. Please generate the banner first.",
          );
          this.isSaving = false;
          return;
        }
        ...
        const response = await fetch(
          `${this.$store.state.root_api}access-engine/api/generate-banner/save-banner/?access-id=` +
            this.$route.query.access_id,
          {
        ...
        onOk: async () => {
          try {
            const response = await fetch(
              ...
              `${this.$store.state.root_api}access-engine/api/generate-banner/generate-banner/${bannerId}/?access-id=` +
                this.$route.query.access_id,
    ...
    getBannerRatio(bannerId) {
      const template = this.templateBanners.find(
        (b) => b.banner_id === bannerId,
      );
