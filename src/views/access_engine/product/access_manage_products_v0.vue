<template>
  <div>
     {{product_access_recieved}}
   
    <br><a-modal v-if="product_access_recieved.create"
...
<a-modal v-if="product_access_recieved.create"
...
<add_furniture_modal_local_3d_model v-if="product_access_recieved.create" v-model:visible="show_add_new_product_locally_3d_model" 
                    ...
                    <div class="products-list">
                        <a-tabs v-model:activeKey="active_tab">
                            ...
                            <div v-if="!filteredProducts.length"  style="height:70vh;gap:20px;;flex-direction:column;display: flex;justify-content: center;align-items: center;">
                                ...
                                <a-button type="primary" v-if="product_access_recieved.create">
                                    Add Furniture
                                </a-button>
                            </div>
...
<div v-if="filteredProducts.length > 0" style="display: flex; justify-content: center; margin-top: 20px; margin-bottom: 20px;">
    ...
    />
                            ...
                            <div style="height:70vh;gap:20px;;flex-direction:column;display: flex;justify-content: center;align-items: center;" v-if="wall.length===0" >
                                ...
                                <a-button type="primary" @click="show_add_new_wall_texture=true" v-if="product_access_recieved.create" >
                                    Add Wall Texture 
                                </a-button>
                            </div>
                                <a-row>
...
<div v-if="floor.length > 0" style="display: flex; justify-content: center; margin-top: 20px; margin-bottom: 20px;">
    ...
    />
                            ...
                            <div  v-if="myLights.length === 0 " style="height:70vh;gap:20px;;flex-direction:column;display: flex;justify-content: center;align-items: center;">
                                ...
                                <a-button v-if="product_access_recieved.create" type="primary">
                                    Add Lights Product 
                                </a-button>
                            </div>
...
>
                        ...
                        <span v-if="record.colors.length > 3">...</span>
                            ...
                            <div style="height:70vh;gap:20px;;flex-direction:column;display: flex;justify-content: center;align-items: center;" v-if="floor.length===0" >
                                ...
                                <a-button type="primary" @click="show_add_new_floor_texture=true"  v-if="product_access_recieved.create">
                                    Add Floor Texture 
                                </a-button>
                            </div>
        ...
        <div v-if="currentView === 'details'" style="max-width: 1200px;">
            ...
            <show_furniture_product  :product_access_recieved="product_access_recieved"  :selectedProduct="selectedProduct" v-if="active_tab=== 'Furniture' && selectedProduct" @edit_product="editProduct" @delete_product="delete_product" @back_product_list="backToList" />
...
truncateText(text, charLimit = 7) {
    ...
    try {
        ...
        add_Product_For(selected_add_newProductModal){
            if (selected_add_newProductModal ==='DYD_AI'){
                this.$router.push("/access-business/create-furniture-product-3d-model-add-product");
            }
            else{
