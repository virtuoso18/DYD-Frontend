          ...
          <a-col :span="12">
            ...
            <div style="display: flex; gap: 10px; align-items: center;">
                ...
                >
                  ...
                  <!-- Texture Badge (if exists) -->
                  <div
                    v-if="color.product_texture"
                    :style="{
                      position: 'absolute',
                      bottom: '-4px',
                      right: '-4px',
                      ...
                      height: '20px',
                      borderRadius: '50%',
                      backgroundImage: `url(${$store.state.root_media_api + color.product_texture.texture})`,
                    ...
                    @click="selectColor(index, color)"
                    :title="`Texture: ${color.product_texture.id}`"
                  ></div>
                </div>
              </div>
          </a-col>
