<template>
  <div class="p-3">
   <a-modal
      ...
      >
        ...
        >
          ...
          >
            ...
            <!-- Brain outline -->
            <path
              d="M50 20 C35 20 25 30 25 40 C25 45 27 50 30 53 L30 70 C30 75 35 80 40 80 L60 80 C65 80 70 75 70 70 L70 53 C73 50 75 45 75 40 C75 30 65 20 50 20 Z"
              fill="url(#aiGradient)"
              opacity="0.3"
            />
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop
                  offset="100%"
                  style="stop-color: #38a169; stop-opacity: 1"
                />
              </linearGradient>
            </defs>
            ...
            <!-- Folder -->
            <path
              d="M20 35 L20 75 C20 78 22 80 25 80 L75 80 C78 80 80 78 80 75 L80 40 C80 37 78 35 75 35 L55 35 L50 30 L25 30 C22 30 20 32 20 35 Z"
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style="flex: 1; text-align: left; font-size: 15px"
            >Generate 3D Light Model with DYD AI</span
          >
        </a-button>
    ...
    <add_furniture_modal_local_3d_model
      v-model:visible="show_add_new_product_locally_3d_model"
      :types="[
        'Modern',
        'Scandinavian',
        'Classic',
    ...
    <div
      class="-translate-y-[1%] min-h-[100vh] md:min-h-[136vh] xl:min-h-[170vh] 2xl:min-h-[150vh] bg-white rounded-2xl"
    >
            ...
            <div className="flex flex-row gap-2 ">
              ...
              >
                ...
                >
                  <!-- bulb outline -->
                  <path
                    d="M12 2a6 6 0 0 0-4.472 10.04c.46.5.872 1.28.872 2.16 0 1.1-.2 2.2-.6 3h6.4c-.4-.8-.6-1.9-.6-3 0-.88.41-1.66.87-2.16A6 6 0 0 0 12 2z"
                  />
                  <!-- filament / detail -->
                  <path d="M10 14h4" />
                  <!-- base -->
              ...
              >
                ...
                >
                  <!-- box -->
                  <path
                    d="M21 8v8a2 2 0 0 1-1 1.73L12 21l-8-3.27A2 2 0 0 1 3 16V8"
                  />
                  <path d="M12 3v5" />
          ...
          <div class="flex flex-wrap items-center gap-3 w-auto sm:w-full">
            ...
            <div class="flex gap-2 sm:flex-col sm:w-full">
              ...
              <button
                type="button"
                @click="show_add_new_wall_texture = true"
                class="flex items-center gap-2 px-1.5 py-1.5 !text-white rounded-md bg-blue-600 font-medium whitespace-nowrap w-auto sm:w-32"
                style="font-family: var(--font-family-main)"
              >
                <svg
                  width="16"
 ...
 <a-col span="18">
              ...
              >
                ...
                >
                  <a-empty
                    :description="'No Wall Textures Available'"
                  ></a-empty>
                  <a-button
                    type="primary"
                    @click="show_add_new_wall_texture = true"
              ...
              <a-tab-pane key="Floor" tab="Floor" v-if="floor.length > 0">
                ...
                >
                  <a-empty
                    :description="'No Floor Textures Available'"
                  ></a-empty>
                  ...
                  <template #bodyCell="{ column, record, index }">
                    ...
                    <template v-if="column.key === 'product'">
                      ...
                      >
                        <img
                          :src="
                            $store.state.root_media_api + record.primary_image
                          "
                          style="
                            width: 60px;
                            height: 60px;
                        ...
                        <div>
                          ...
                          >
                            {{
                              truncateText(
                                record.name || "No title available",
                                13
                              )
                            }}
                          </div>
            ...
            >
              ...
              >
                <template #bodyCell="{ column, record, index }">
                  ...
                  <template v-if="column.key === 'product'">
                    ...
                    >
                      <img
                        :src="
                          $store.state.root_media_api +
                          (record.product_images.length > 0
                            ? record.product_images[0].image
                            : record.texture_image)
                        "
                        style="
                          width: 60px;
                          height: 60px;
                  ...
                  <template v-if="column.key === 'type'">
                    <span>{{
                      record.brand || record.model_number || "Texture"
                    }}</span>
                  </template>
                  ...
                  <template v-if="column.key === 'colors'">
                    <div style="display: flex; align-items: center; gap: 6px">
                      <div
                        v-for="(color, index) in record.associated_colors.slice(
                          0,
                          3
                        )"
                        :key="index"
                      ...
                      ></div>
                      <span v-if="record.associated_colors.length > 3"
                        >...</span
                      >
                    </div>
                  </template>
            ...
            <a-tab-pane key="Floor" tab="Floor" v-if="floor.length > 0">
              ...
              >
                <template #bodyCell="{ column, record, index }">
                  ...
                  <template v-if="column.key === 'type'">
                    <span>{{
                      record.brand || record.model_number || "Floor Tile"
                    }}</span>
                  </template>
                  ...
                  <template v-if="column.key === 'colors'">
                    <div style="display: flex; align-items: center; gap: 6px">
                      <div
                        v-for="(color, i) in record.associated_colors?.slice(
                          0,
                          3
                        )"
                        :key="i"
                    ...
                    <span style="font-weight: 600; color: #333">
                      <template v-if="record.is_on_sale">
                        <del style="font-size: 10px; color: #999"
                          >${{ record.price_per_sqm }}</del
                        >
                        &nbsp;${{
                          record.sale_price_per_sqm ||
                          record.current_price_per_sqm
                        }}
                      </template>
                      <template v-else>
...
:scroll="{ x: 800 }" style="background: white; border-radius: 8px; overflow: hidden; cursor:pointer"> -->
      ...
      <div
        ...
        style="max-width: 1200px; padding: 3px"
      >
...
import add_furniture_modal_local_3d_model_create_variation from '@/views/access_engine/product/my_products/add_new_product/add_furniture_modal_local_3d_model_create_variation.vue'

// add new
import add_new_floorTexture from '@/views/access_engine/product/my_products/add_new_product/add_floor_texture.vue'
import add_new_wallTexture from '@/views/access_engine/product/my_products/add_new_product/add_wall_texture.vue'
import add_new_Light from '@/views/access_engine/product/my_products/add_new_product/add_light.vue'
import add_new_furniture from '@/views/access_engine/product/my_products/add_new_product/add_furniture.vue'

// update_existing
import edit_floorTexture from '@/views/access_engine/product/my_products/update_product/floor_texture.vue' 
import edit_wallTexture from '@/views/access_engine/product/my_products/update_product/wall_texture.vue'
import edit_furniture from '@/views/access_engine/product/my_products/update_product/furniture.vue'

import edit_Light from '@/views/access_engine/product/my_products/update_product/light.vue'
import edit_Light_hanging_3d from '@/views/access_engine/product/my_products/update_product/light_hanging_3d.vue'
import edit_Light_sunk from '@/views/access_engine/product/my_products/update_product/light_sunk.vue'
import edit_Light_unsunk from '@/views/access_engine/product/my_products/update_product/light_unsunk.vue'

// show existing
import show_floorTexture_product from '@/views/access_engine/product/my_products/product_details/floor_texture.vue' 
import show_wallTexture_product from '@/views/access_engine/product/my_products/product_details/wall_texture.vue'
import show_furniture_product from '@/views/access_engine/product/my_products/product_details/furniture_product.vue'

// differentt Light Products Details Component 
import show_Light_product_sunk from '@/views/access_engine/product/my_products/product_details/light_product_sunk.vue'
import show_Light_product_unsunk from '@/views/access_engine/product/my_products/product_details/light_product_ununk.vue'
import show_Light_product_3D from '@/views/access_engine/product/my_products/product_details/light_product_3d.vue'
...
export default {
    ...
    data() {
        return {
            product_access_recieved:this.access_recieved.product,
    ...
    methods: {
      ...
      try {
        ...
        this.prepopulatedProductData = {
          ...
          images:
            this.selectedProduct.product_images?.map((img) => ({
              url: img.image,
              id: img.id,
              name: `Image ${img.id}`,
              isExisting: true,
...
truncateText(text, charLimit = 7) {
        ...
        //     try {
        //         const token = localStorage.getItem('token');
        //         const response = await fetch(`${this.$store.state.root_api}access-engine/api/business-products/read-product-furniture/`, {
        //             method: 'GET',
        //             headers: {
        //                 'Authorization': `Token ${token}`
        //             }
    ...
    try {
        ...
        //     try {
        //         const token = localStorage.getItem('token');
        //         const response = await fetch(`${this.$store.state.root_api}access-engine/api/business-products/read-product-light/`, {
        //             method: 'GET',
        //             headers: {
        //                 'Authorization': `Token ${token}`
        //             }
    ...
    try {
        ...
        //     try {
        //         const token = localStorage.getItem('token');
        //         const response = await fetch(`${this.$store.state.root_api}access-engine/api/business-products/read-product-wall-texture/`, {
        //             method: 'GET',
        //             headers: {
        //                 'Authorization': `Token ${token}`
        //             }
    ...
    try {
        ...
        //     try {
        //         const token = localStorage.getItem('token');
        //         const response = await fetch(`${this.$store.state.root_api}access-engine/api/business-products/read-product-floor-tile/`, {
        //             method: 'GET',
        //             headers: {
        //                 'Authorization': `Token ${token}`
        //             }
    ...
    try {
        ...
        async fetchProductDetails(product_id) {
             try {
                ...
                // console.log(url_product_details)
                const token = localStorage.getItem('token');
        ...
        add_Product_For(selected_add_newProductModal){
            if (selected_add_newProductModal ==='DYD_AI'){
                this.$router.push("/access-business/create-furniture-product-3d-model-add-product?access_id="+this.$route.query.access_id+"&brand="+this.$route.query.brand);
            }
            else{
                this.show_add_new_product_locally_3d_model=true
                console.log(selected_add_newProductModal)
