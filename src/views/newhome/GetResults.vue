...
export default {
  ...
  props: {
    mainTitle: {
      type: String,
      default: 'Get listing-ready results in seconds'
    },
    subText1: {
      type: String,
      default: 'Turn your property photos into stunning visuals in three simple'
    },
    subText2: {
      type: String,
      default: 'steps to attract buyers and enhance your listings.'
    }
  }
}
</script>
