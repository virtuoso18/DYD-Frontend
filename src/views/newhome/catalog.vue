<template>
  <div class="w-full bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="flex justify-center">   

        <div class="max-w-6xl px-auto ">
          <!-- Title -->
          <h2 class="!text-center !font-poppins !font-normal !text-[32px] !leading-[100%] !tracking-[1%] mb-12">
  Shop By AI Catalog
</h2>
    
          <!-- Grid Container -->
          <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6  sm:gap-6 ">
