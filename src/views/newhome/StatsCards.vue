<template>
  <a-col :span="24">
    <a-row :gutter="[20, 20]" class="w-full">
      <!-- 95% Cheaper Card -->
      <a-col :xs="12" :sm="12" :md="4" :lg="4" class="rounded-lg pt-5">
        <div class="bg-[--color-bg-gray] w-full h-[223px] border border-[--color-border-gray] rounded-lg flex flex-col items-center justify-center">
          <h1 class="text-5xl m-0 font-semibold text-[--color-primary]">95%</h1>
          <p class="text-base mt-2 mb-0">Cheaper</p>
        </div>
      </a-col>
      ...
      <a-col :xs="12" :sm="12" :md="4" :lg="4" class="rounded-lg pt-5">
        <div class="bg-[--color-bg-gray] w-full h-[223px] border border-[--color-border-gray] rounded-lg flex flex-col items-center justify-center">
          <h1 class="text-5xl m-0 font-semibold text-[--color-primary]">10,000+</h1>
          <p class="text-base mt-2 mb-0">Users</p>
        </div>
      </a-col>

      <!-- Features Card -->
      <a-col :xs="24" :sm="24" :md="16" :lg="16" class="rounded-lg pt-5 pb-10">
        <div class="w-full h-[223px] bg-[--color-bg-gray] border border-[--color-border-gray] rounded-lg flex justify-around items-center p-5">
          <!-- Feature 1 -->
          <div class="flex flex-col items-center justify-center text-center gap-3">
            ...
            <span class="text-sm font-medium">Instant results</span>
          </div>
          ...
          <div class="flex flex-col items-center justify-center text-center gap-3">
            ...
            <span class="text-sm font-medium">Multi-view staging</span>
          </div>
          ...
          <div class="flex flex-col items-center justify-center text-center gap-3">
            ...
            <span class="text-sm font-medium">Furniture removal</span>
          </div>
        </div>
      </a-col>
    </a-row>
