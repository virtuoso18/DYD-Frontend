...
export default {
  ...
  mounted() {
    ...
    this.checkAdminStaffUserhaveAccess();
...
async checkAdminStaffUserhaveAccess() {
      try {
        const response = await fetch(
          // `${this.$store.state.root_api}access-engine/api/check-employee-user/`,
          `${this.$store.state.root_api}admin-dashboard/platform-admin-api/staff-management/check-employee-user/`,
          {
            method: "GET",
            headers: {
