...
<template>
  ...
  ><div style="text-align: center;color:white;">
    ...
    <h1 style="color: white; font-size: 48px; text-shadow: 2px 2px 4px rgba(0,0,0,0.5);">Shop Smarter, Live Better – AI Powered <br> Finds for You!</h1>
    <p style="font-size:18px;">Browse a smart catalog designed to understand your needs and offer you the best options with ease.</p>
  </div>
  </div>
