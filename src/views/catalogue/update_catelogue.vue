...
>
  ...
  v-if="(current_tab === 'image' && closeShareMenu) && !(current_tab === 'image' && active_tab_image === 'home_design')"
>
  <!-- Left: Share section -->
  ...
  <div     v-if="LockCanvasOperation===false"
    ...
    ((current_tab=='image' && active_tab_image ==='item_replacement' && select_replace==='Lights' && selected_light_type==='hanging') ? 'light-3d-height-adjuster':'') || 
    ...
    <div>
      ...
      <div class="main_panel">
        <a-row class="full-height">
          ...
          <a-col :span="user?.user_type ==='Business' ? 1 :0" class="left-sidebar">
          ...
          <a-col :span="user?.user_type ==='Business' || user?.user_type ==='User' ? 6 :7" class="middle-panel" v-if="current_tab=='image'" >
            <div class="controls-container">
              <!-- Top Action Buttons -->
              <div class="action-buttons">
