      ...
      <a-row>
        ...
        >
          ...
          <img
            ...
            :src="this.$store.state.root_media_api + histry_card.image"
            class="example-image"
          />
          <!-- </router-link> -->
        </a-col>
      ...
      <svg class="w-7 h-7" fill="none" viewBox="0 0 27 26">
        ...
        <path d="M18.1919 8.39785L9.57176 16.6154M18.1919 16.6154L9.57176 8.39785" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <div
            :style="{
              width: '100%',
              height: closeShareMenu ? 'calc(100% - 40px)' : '100%',
            }"
          >
            <canvas_floor_render
              v-if="
      ...
      <div>
        ...
        <div class="main_panel">
          <a-row class="full-height">
            ...
            <a-col
              :span="
                user?.user_type !== 'User' && user?.user_type !== 'Professional'
                  ? 1
                  : 0
              "
              class="left-sidebar"
