  ...
  <div class="signin-container">
    <div class="logo-section">
      <div class="logo">
        <div class="logo-icon">
          <svg viewBox="0 0 40 40" width="40" height="40">
            <g stroke="white" stroke-width="2" fill="none">
              <!-- Building outline -->
              <rect x="8" y="15" width="8" height="20"/>
              <rect x="12" y="10" width="8" height="25"/>
              <rect x="16" y="5" width="8" height="30"/>
              <rect x="20" y="8" width="8" height="27"/>
              <!-- Windows -->
        ...
        <div class="logo-text">
          <div class="brand-name">D.Y.D</div>
          <div class="tagline">design your dream</div>
        </div>
      </div>
    </div>
    ...
    <div class="form-section">
      ...
      <div class="form-container">
        ...
        <a-button type="primary" size="large" class="continue-btn" block>
          Continue
        </a-button>
