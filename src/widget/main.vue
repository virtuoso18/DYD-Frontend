  ...
  <div class="home-container">
    ...
    <div class="content-wrapper">
      ...
      <div class="upload-row px-2 sm:px-0">
        ...
        <a-alert
          style="margin-bottom: 10px"
          v-show="this.queryParams.product_id"
 ...
 === this.selectedImage?.brand) {
    ...
    async saveAndContinue() {
      ...
      try {
        ...
        if (this.queryParams.brand) {
          formData.append("business_owner", this.queryParams.brand
);
        ...
        if (response.ok && !responseData.error) {
          ...
          // localStorage.setitem('rooms_created',[responseData.room_id])
    ...
    async startTestRoom(room_id) {
      ...
      try {
        ...
        if (this.queryParams.brand) {
          ...
          url = `${this.$store.state.root_api}room/api/start-example-room/${room_id}?brand=${this.queryParams.brand
}`;
        }
        const response = await fetch(url, {
          method: "GET",
